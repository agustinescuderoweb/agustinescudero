  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Diseño de Sitios Web Profesionales"
        />
        ...
        <meta
          property="og:url"
          content="https://agustinescuderoweb.com/servicios/sitios"
        />
        ...
        <section className="flex flex-col md:flex-row min-h-screen border-b border-white/[0.06]">
          <div className="flex flex-col justify-end flex-1 px-8 md:px-16 pb-16 pt-32 gap-6">
            ...
            <p className="text-white/50 max-w-md text-[0.95rem] leading-relaxed">
              Tu sitio web es la base de tu presencia digital. Diseño sitios
              modernos, rápidos y pensados para transmitir confianza y convertir
              visitas en clientes.
            </p>
