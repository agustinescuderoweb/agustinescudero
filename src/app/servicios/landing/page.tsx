...
const faqs = [
  {
    pregunta: '¿Cuánto tarda una landing page?',
    respuesta: 'Entre 1 y 5 días, dependiendo del contenido y revisiones.',
  },
  {
    pregunta: '¿Incluye SEO?',
    respuesta: 'Sí, incluye estructura optimizada para Google desde el inicio.',
  },
  {
    pregunta: '¿Se puede escalar luego a un sitio completo?',
    respuesta: 'Sí, la landing puede evolucionar a un sitio web sin rehacer todo.',
  },
]
        ...
        <section className="flex flex-col md:flex-row min-h-screen border-b border-white/[0.06]">
          ...
          <div className="flex flex-col justify-end flex-1 px-8 md:px-16 pb-16 pt-32 gap-6">
            ...
            <p className="text-white/50 max-w-md text-[0.95rem] leading-relaxed">
              Landing pages optimizadas para generar contactos, ventas y resultados
              reales. Pensadas para campañas publicitarias y negocios que quieren crecer.
            </p>
