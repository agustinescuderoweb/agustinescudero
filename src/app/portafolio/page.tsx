...
function Page() {
  return (
    ...
    <div className="bg-[#0b0b0b] text-white">
      ...
      {/* HERO */}
      <section className="flex flex-col md:flex-row items-center justify-center gap-16 w-full min-h-[90vh] bg-gradient-to-b from-black/80 to-black/40 px-6 md:px-16">
