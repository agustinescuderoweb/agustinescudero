  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row w-screen justify-center items-center md:justify-between bg-black bg-opacity-30 text-center">
                <div className='flex flex-col flex-[50%] justify-center items-center overflow-hidden gap-10 pt-16 pb-16'><h1 className="text-white text-4xl font-bold">Hola!</h1>
                ...
                <a href='https://wa.link/elp2e3' className="relative z-10">Pedí tu Web</a>
                </button>
